...
export const CanvasRevealEffect = ({
  ...
  return (
    <div className={cn("h-full relative bg-white w-full", containerClassName)}>
      ...
      {showGradient && (
        <div className="absolute inset-0 bg-gradient-to-t from-[#fdfcfb] to-[84%]" />
      )}
    </div>
  );
};
...
const ShaderMaterial = ({
  ...
  interface PreparedUniform {
    value: THREE.Vector3[] | number | THREE.Vector2;
    type?: string;
  }

  const getUniforms = () => {
    const preparedUniforms: Record<string, PreparedUniform> = {}; // More specific type than `any`
  ...
  return (
    <mesh ref={ref as unknown as string}>
