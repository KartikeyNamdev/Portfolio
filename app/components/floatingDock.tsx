...
const FloatingDockMobile = ({
  ...
  return (
    <div
      className={cn("fixed bottom-8 right-4 z-50 block md:hidden", className)}
    >
      <AnimatePresence>
        {open && (
          <motion.div
...
const FloatingDockDesktop = ({
  ...
  const dockWidth = `${Math.min(items.length * 80 + 32, 600)}px`;
  ...
  return (
    <Link href={href}>
      <motion.div
        ...
        className="aspect-square rounded-full bg-transparent backdrop-blur-md flex items-center justify-center relative"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
