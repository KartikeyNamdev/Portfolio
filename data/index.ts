...
export const gridItems = [
  {
    id: 1,
    title: "1st Runner up at Tech Conclave by Talrop and Times of India",
    description: "",
    className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh]",
    imgClassName: "w-full h-10/6",
  ...
  {
    id: 2,
    title: `Checkout my submission on Leetcode Problems`,
    description: "C++",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2 ",
    imgClassName: "h-10/6 opacity-75",
    titleClassName: "justify-start",
    img: "/leetcode3.jpg",
    spareImg: "",
    href: "https://leetcode.com/problems/peak-index-in-a-mountain-array/solutions/6588534/peakindexinmountainarray-solution-by-kar-6h4q",
  },
  {
    id: 3,
    title: "My tech stack",
  ...
  {
    id: 4,
    title: "Blog on How WebSockets, Queues, and Pub/Sub Save Your Backend",
    description: "",
  ...
  {
    id: 5,
    title: "Ideated Testify - a SaaS for testimonial creation and embeds.",
    description: "The Inside Scoop",
    className: "md:col-span-3 md:row-span-2 ",
    imgClassName: "w-full h-5/6 opacity-50",
